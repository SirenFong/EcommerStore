  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full bg-white h-full md:static md:w-auto transition-all"
      }
    >
      <Link href={"/"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          className={pathname.includes("/storages") ? activeLink : inactiveLink}
          href={"/storages"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          className={
            pathname.includes("/paymentmethods") ? activeLink : inactiveLink
          }
          href={"/paymentmethods"}
        >
          <svg
        ...
        <Link
          className={pathname.includes("/coupons") ? activeLink : inactiveLink}
          href={"/coupons"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          className={pathname.includes("/promotions") ? activeLink : inactiveLink}
          href={"/promotions"}
        >
        ...
        {/* <Link
          className={
            pathname.includes("/promotions") ? activeLink : inactiveLink
          }
          href={"/promotions"}
        >
          <svg
        ...
        {/* <Link
          className={
            pathname.includes("/advertisement") ? activeLink : inactiveLink
          }
          href={"/advertisement"}
        >
          <svg
        ...
        <Link
          className={pathname.includes("/cost") ? activeLink : inactiveLink}
          href={"/cost"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
