...
export default function PromotionForm({
  ...
  useEffect(() => {
    ...
    setSelectedValuesDisplay(
      values.map((item) => (type == "1" ? item.title : item.name))
    );
  }, [values]);
        ...
        <Modal isOpen={open}>
          <>
            <div className="w-[50rem]">
                  ...
                  <>
                    <div className="w-3/3 p-7">
                      ...
                      <input
                        ...
                        value={
                          reducedproperties === null ? "" : reducedproperties
                        }
                      />
                    </div>
                  </>
              ...
              <button id="btnId" type="button" onClick={saveValue}>
                thêm
              </button>
            </div>
          </>
